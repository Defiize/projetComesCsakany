...
class Professeur extends \App\Entity\Professeur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Professeur' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Professeur' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Professeur' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\Professeur' . "\0" . 'mail', '' . "\0" . 'App\\Entity\\Professeur' . "\0" . 'avis', '' . "\0" . 'App\\Entity\\Professeur' . "\0" . 'matieres', '' . "\0" . 'App\\Entity\\Professeur' . "\0" . 'cours'];
        }
     ...
     * {@inheritDoc}
     */
    public function setMail(string $mail): \App\Entity\Professeur
    {
