...
class __TwigTemplate_26da396fc00a611665ab3ce4e48eff57 extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "C:\\Users\\bcsakanay\\Documents\\DEV\\edt\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\field\\email.html.twig");
    }
}
